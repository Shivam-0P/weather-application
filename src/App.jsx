...
function App() {
  ...
  async function onSearchClick() {
    ...
    await axios.get(`https://api.weatherapi.com/v1/forecast.json?key=${`b79b62b39bc7416aa60180047250411`}&q=${searchCity}&days=1&aqi=no&alerts=no`)
      .then((response) => {
    ...
    await axios.get(`https://api.weatherapi.com/v1/forecast.json?key=${`b79b62b39bc7416aa60180047250411`}&q=${city}&days=5&aqi=no&alerts=no`)
      .then((response) => {
        // console.log(response);
        let minMaxArray = [];
        let imageArray = [];
